...
public class UserDAO {
    ...
    private void ensureAdminExists() {
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String checkSql = "SELECT COUNT(*) FROM account WHERE useName = ?";
            ...
            try (PreparedStatement checkPs = conn.prepareStatement(checkSql)) {
                ...
                if (rs.next() && rs.getInt(1) == 0) {
                    ...
                    // chưa có thì thêm
                    String insertSql = "INSERT INTO account (useName, password, fullName, role) VALUES (?, ?, ?, ?)";

                    try (PreparedStatement insertPs = conn.prepareStatement(insertSql)) {
                        insertPs.setString(1, "admin");
                        insertPs.setString(2, "123");
                        insertPs.setString(3, "Administrator");
